...
def data():
    ...
    pytest.vcf = "./tests/data/test.match.pct.data.vcf"
    pytest.score_file = "./tests/results/test.match.pct.score.exp.results"
    pytest.output = "./tests/results/test.match.pct.results"
    pytest.exp_output = "./tests/results/test.match.pct.exp.results"
